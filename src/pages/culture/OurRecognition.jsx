      ...
      <section>
        <div className="relative min-h-screen container mx-auto ">
          ...
          <div className="flex">
            ...
            <div>
              <h2 className="text-5xl">Awards & Certifications</h2>
          ...
          <div className="flex mt-24">
            <div className="w-2/5"></div>
            <div>
              <h2 className="text-5xl">Media Mentions</h2>
              <p className="my-12 w-[877px]">
              Here are some social proofs
              </p>
             <a href="/" className="underline text-blue-600 text-2xl flex">Link to press <svg width="34" height="35" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg">
